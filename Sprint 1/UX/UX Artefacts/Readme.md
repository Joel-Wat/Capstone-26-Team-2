# UX Artefacts-Sprint 1

## Overview

UX artefacts created for the GP26 Dynamic Forms platform based on the BA user journey, user requirements, and existing forms in monday.com.
The UX artefacts include user personas, initial wireframes, and refined interface designs.

## User Personas

Three user personas were created to represent the main users of the GP26 Dynamic Forms platform. The personas identify user goals,behaviours, pain points.

### Persona 1 : Sarah Mitchell
...
Login interface for authorised users.
<img width="800" height="423" alt="login_form_success" src="https://github.com/user-attachments/assets/e56d4f3b-85f7-4bb2-a0b3-2f8f145433e0" />

<img width="800" height="417" alt="login_form_error" src="https://github.com/user-attachments/assets/d48a8d06-97cf-4b83-bdde-3d1430d128ae" />
...
<img width="800" height="440" alt="dynamic_form" src="https://github.com/user-attachments/assets/78dafe8c-2632-4f92-a4fe-8d1022da008d" />
...
This displays telecommunication submissions with search and filtering functionality.

<img width="800" height="496" alt="telecom_results" src="https://github.com/user-attachments/assets/b479fe15-3df6-46e6-bd36-e79c29f0a193" />

<img width="800" height="489" alt="filter_feature" src="https://github.com/user-attachments/assets/09d0408f-26a5-4904-b207-e1d377c3b13d" />
...
- Navigation between service categories and results
- Search functionality
- Filter options
